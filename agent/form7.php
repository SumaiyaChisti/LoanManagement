...
if(isset($_POST['submit'])) {
  ...
  $fullpath15 = $dir . basename($_FILES['GST_3B']['name']);
  move_uploaded_file($_FILES['GST_3B']['tmp_name'],$fullpath15);

    $q = "INSERT INTO `form7`(`name`,`dob`,`gender`,`contact`,`email`,`address`,`pan_id`,`property_ownership`,`marital_status`,`place_of_work`,`job_title`,`work_address`,`years_employed`,`monthly_net_income`,`pan_card`,`aadhaar_card`,`residential_bill`,`license`,`GST_registration`,`relationship_proof`,`ITR`,`banking`,`SA_banking`,`photographs`,`sale_agreement`,`chain_agreement`,`OC_CC`,`BMC`,`certificate`,`GST_3B`,`bank_name`,`branch_name`,`account_number`,`account_type`,`purpose_of_loan`,`requested_loan_amount`,`terms_in`,`status`,`class`)VALUES ('$_POST[name]','$_POST[dob]','$_POST[gender]','$_POST[contact]','$_POST[email]','$_POST[address]','$_POST[pan_id]','$_POST[property_ownership]','$_POST[marital_status]','$_POST[place_of_work]','$_POST[job_title]','$_POST[work_address]','$_POST[years_employed]','$_POST[monthly_net_income]','$fullpath','$fullpath1','$fullpath2','$fullpath3','$fullpath4','$fullpath5','$fullpath6','$fullpath7','$fullpath8','$fullpath9','$fullpath10','$fullpath11','$fullpath12','$fullpath13','$fullpath14','$fullpath15','$_POST[bank_name]','$_POST[branch_name]','$_POST[account_number]','$_POST[account_type]','$_POST[purpose_of_loan]','$_POST[requested_loan_amount]','$_POST[terms_in]','pending','badge-warning')";
...
<script src="assets/js/preloader.js"></script>
  ...
  <div class="container pt-4">
    <h3 style="color:blue; font-family:fancy monospace">Housing Loan-Self Employed </h3>

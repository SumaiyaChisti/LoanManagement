...
if(isset($_POST['submit'])) {
  ...
  $fullpath4 = $dir . basename($_FILES['MOA_AOA']['name']);
  move_uploaded_file($_FILES['MOA_AOA']['tmp_name'],$fullpath4);
  $fullpath5 = $dir . basename($_FILES['ITRfinancials_AuditReport']['name']);
  move_uploaded_file($_FILES['ITRfinancials_AuditReport']['tmp_name'],$fullpath5);
  $fullpath6 = $dir . basename($_FILES['individual_ITR']['name']);
  move_uploaded_file($_FILES['individual_ITR']['tmp_name'],$fullpath6);
  $fullpath7 = $dir . basename($_FILES['GST_registration']['name']);
  move_uploaded_file($_FILES['GST_registration']['tmp_name'],$fullpath7);
  $fullpath8 = $dir . basename($_FILES['individual_banking']['name']);
  move_uploaded_file($_FILES['individual_banking']['tmp_name'],$fullpath8);
  $fullpath9 = $dir . basename($_FILES['list_of_directors']['name']);
  move_uploaded_file($_FILES['list_of_directors']['tmp_name'],$fullpath9);
  $fullpath10 = $dir . basename($_FILES['ongoing_loans']['name']);
  move_uploaded_file($_FILES['ongoing_loans']['tmp_name'],$fullpath10);
  $fullpath11 = $dir . basename($_FILES['repayment']['name']);
  move_uploaded_file($_FILES['repayment']['tmp_name'],$fullpath11);
  $fullpath12 = $dir . basename($_FILES['photographs']['name']);
  move_uploaded_file($_FILES['photographs']['tmp_name'],$fullpath12);
  $fullpath13 = $dir . basename($_FILES['GST_3B']['name']);
  move_uploaded_file($_FILES['GST_3B']['tmp_name'],$fullpath13);
...
<script src="assets/js/preloader.js"></script>
  ...
  <div class="container pt-4">
    <h3 style="color:blue; font-family:fancy monospace">Business Loan-PVT LTD</h3>

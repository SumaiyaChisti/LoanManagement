...
if(isset($_POST['submit'])) {
  ...
  $fullpath3 = $dir . basename($_FILES['office_bill']['name']);
  move_uploaded_file($_FILES['office_bill']['tmp_name'],$fullpath3);
  $fullpath4 = $dir . basename($_FILES['partnership_dead']['name']);
  move_uploaded_file($_FILES['partnership_dead']['tmp_name'],$fullpath4);
  $fullpath5 = $dir . basename($_FILES['GST_3B']['name']);
  move_uploaded_file($_FILES['GST_3B']['tmp_name'],$fullpath5);
  $fullpath6 = $dir . basename($_FILES['ITRfinancials_AuditReport']['name']);
  move_uploaded_file($_FILES['ITRfinancials_AuditReport']['tmp_name'],$fullpath6);
  $fullpath7 = $dir . basename($_FILES['ITR_partners']['name']);
  move_uploaded_file($_FILES['ITR_partners']['tmp_name'],$fullpath7);
  $fullpath8 = $dir . basename($_FILES['company_banking']['name']);
  move_uploaded_file($_FILES['company_banking']['tmp_name'],$fullpath8);
  $fullpath9 = $dir . basename($_FILES['individual_banking']['name']);
  move_uploaded_file($_FILES['individual_banking']['tmp_name'],$fullpath9);
  $fullpath10 = $dir . basename($_FILES['OnGoing_Loans']['name']);
  move_uploaded_file($_FILES['OnGoing_Loans']['tmp_name'],$fullpath10);
  $fullpath11 = $dir . basename($_FILES['list_of_partners']['name']);
  move_uploaded_file($_FILES['list_of_partners']['tmp_name'],$fullpath11);
  $fullpath12 = $dir . basename($_FILES['photographs']['name']);
  move_uploaded_file($_FILES['photographs']['tmp_name'],$fullpath12);
  $fullpath13 = $dir . basename($_FILES['GST_registration']['name']);
  move_uploaded_file($_FILES['GST_registration']['tmp_name'],$fullpath13);
  
    $q = "INSERT INTO `form2`(`name`,`dob`,`gender`,`contact`,`email`,`address`,`pan_id`,`property_ownership`,`marital_status`,`place_of_work`,`job_title`,`work_address`,`years_employed`,`monthly_net_income`,`pan_card`,`aadhaar_card`,`residential_bill`,`office_bill`,`partnership_dead`,`GST_3B`,`ITRfinancials_AuditReport`,`ITR_partners`,`company_banking`,`individual_banking`,`OnGoing_Loans`,`list_of_partners`,`photographs`,`GST_registration`,`bank_name`,`branch_name`,`account_number`,`account_type`,`purpose_of_loan`,`requested_loan_amount`,`terms_in`,`status`,`class`)VALUES ('$_POST[name]','$_POST[dob]','$_POST[gender]','$_POST[contact]','$_POST[email]','$_POST[address]','$_POST[pan_id]','$_POST[property_ownership]','$_POST[marital_status]','$_POST[place_of_work]','$_POST[job_title]','$_POST[work_address]','$_POST[years_employed]','$_POST[monthly_net_income]','$fullpath','$fullpath1','$fullpath2','$fullpath3','$fullpath4','$fullpath5','$fullpath6','$fullpath7','$fullpath8','$fullpath9','$fullpath10','$fullpath11','$fullpath12','$fullpath13','$_POST[bank_name]','$_POST[branch_name]','$_POST[account_number]','$_POST[account_type]','$_POST[purpose_of_loan]','$_POST[requested_loan_amount]','$_POST[terms_in]','pending','badge-warning')";
...
<script src="assets/js/preloader.js"></script>
  ...
  <div class="container pt-4">
    <h3 style="color:blue; font-family:fancy monospace">Business Loan-Partnership</h3>
...
<div class="form-outline mt-4">
  ...
  <label class="form-label" for="formControlLg">Monthly Net Income</label>
    ...
    <h6 style="margin-top: 15px; color:blue" class="form-label" for="formControlLg">Pan Card Copy of Company and All Partners</h6>
    <div class="form-outline mt-4">
  <input type="file" id="formControlLg" name="pan_card"  class="form-control form-control-lg" required />
    </div>
    <h6 style="margin-top: 15px; color:blue" class="form-label" for="formControlLg">Aadhaar Card Of All Partners</h6>
    <div class="form-outline mt-4">
  <input type="file" id="formControlLg" name="aadhaar_card"  class="form-control form-control-lg" required />
    </div>
    <h6 style="margin-top: 15px; color:blue" class="form-label" for="formControlLg">Residential Light Bill And Telephone Bill Of All Partners(if rented then rent Agreement)</h6>
    <div class="form-outline mt-4">
  <input type="file" id="formControlLg" name="residential_bill"  class="form-control form-control-lg" required />
    </div>
    <h6 style="margin-top: 15px; color:blue" class="form-label" for="formControlLg">Office Light Bill And Telephone Bill(if rented then rent agreement)</h6>
    <div class="form-outline mt-4">
  <input type="file" id="formControlLg" name="office_bill"  class="form-control form-control-lg" required />
    </div>
    <h6 style="margin-top: 15px; color:blue" class="form-label" for="formControlLg">Partnership Deed</h6>
    <div class="form-outline mt-4">
  <input type="file" id="formControlLg" name="partnership_dead"  class="form-control form-control-lg" required />
    </div>
  ...
  <input type="file" id="formControlLg" name="GST_3B"  class="form-control form-control-lg" required />
    ...
    <h6 style="margin-top: 15px; color:blue" class="form-label" for="formControlLg">Last 3 years company ITR Financials with Audit Report(CA ATTESTED)</h6>
    <div class="form-outline mt-4">
  <input type="file" id="formControlLg" name="ITRfinancials_AuditReport"  class="form-control form-control-lg" required />
    </div>
    <h6 style="margin-top: 15px; color:blue" class="form-label" for="formControlLg">Last 3 Years Indiviual ITR of All Partners</h6>
    <div class="form-outline mt-4">
  <input type="file" id="formControlLg" name="ITR_partners"  class="form-control form-control-lg" required />
    </div>
    <h6 style="margin-top: 15px; color:blue" class="form-label" for="formControlLg">Last 12 Months Company Banking Of All Accounts As Per Balance Sheet</h6>
    <div class="form-outline mt-4">
  <input type="file" id="formControlLg" name="company_banking"  class="form-control form-control-lg" required />
    </div>
    <h6 style="margin-top: 15px; color:blue" class="form-label" for="formControlLg">Last 6 Months Indiviual Banking Of All Partners</h6>
    <div class="form-outline mt-4">
  ...
  <input type="file" id="formControlLg" name="OnGoing_Loans"  class="form-control form-control-lg" required />
    ...
    <h6 style="margin-top: 15px; color:blue" class="form-label" for="formControlLg">List Of Partners And Share holding Apptern On Company LetterHead</h6>
    <div class="form-outline mt-4">
  <input type="file" id="formControlLg" name="list_of_partners"  class="form-control form-control-lg" required />
    </div>
    <h6 style="margin-top: 15px; color:blue" class="form-label" for="formControlLg">Photographs 3-4 Of Each Partner</h6>
    <div class="form-outline mt-4">
  <input type="file" id="formControlLg" name="photographs"  class="form-control form-control-lg" required />
    </div>
    <h6 style="margin-top: 15px; color:blue" class="form-label" for="formControlLg">GST Resgistration</h6>
    <div class="form-outline mt-4">

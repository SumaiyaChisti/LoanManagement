...
<script src="assets/js/preloader.js"></script>
  ...
  <div class="container pt-4">
    <h3 style="font-family: fancy monospace;" >Urban Money Reports</h3>
    <br>
...
<tr>
  ...
  <td><a class="btn btn-success"href="viewreports.php?status=<?php echo $data['name'];?>"><i class="fa-solid fa-eye">View</i></a></td>
